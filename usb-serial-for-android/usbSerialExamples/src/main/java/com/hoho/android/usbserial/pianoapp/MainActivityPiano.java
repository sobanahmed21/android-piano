...
import com.hoho.android.usbserial.examples.MainActivity;
...
public class MainActivityPiano extends AppCompatActivity implements View.OnClickListener {
...
//         name = i_data.getStringExtra("SENDER_KEY");
...
ter=findViewById(R.id.ter);
       ...
       // The recording code for the piano keys
        ...
        ter.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivityPiano.this, MainActivity.class));
            }
        });
...
/*
 ...
 /*           case R.id.tg6:*/
    ...
    public void play(View view) {
        ...
        Intent intent = new Intent(MainActivityPiano.this,PLayingActivity.class);
